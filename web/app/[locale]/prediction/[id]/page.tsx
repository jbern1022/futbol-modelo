...
export default async function PredictionPage({
  ...
  const t = await getTranslations("PredictionPage");
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-black">
        <main className="mx-auto max-w-2xl px-6 py-16">
          ...
          <h1 className="mt-6 text-2xl font-semibold text-black dark:text-zinc-50">
            {t("predictionNotFound")}
          </h1>
          <p className="mt-2 text-zinc-500">
            {t("predictionNotFoundExplainer")}
          </p>
        </main>
      </div>
    );
      ...
      <main className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="mt-6 rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          <div className="flex items-baseline justify-between">
            <span className="text-sm text-zinc-500">{t("statedProbability")}</span>
          ...
          {p.outcome && p.outcome !== "void" && (
            <div className="mt-4 flex items-baseline justify-between border-t border-zinc-100 pt-4 dark:border-zinc-800">
              <span className="text-sm text-zinc-500">{t("actualResult")}</span>
        ...
        <dl className="mt-8 space-y-3 text-sm">
          <div className="flex justify-between border-b border-zinc-200 pb-2 dark:border-zinc-800">
            <dt className="text-zinc-500">{t("fixture")}</dt>
          ...
          <div className="flex justify-between border-b border-zinc-200 pb-2 dark:border-zinc-800">
            <dt className="text-zinc-500">{t("lockedAt")}</dt>
            <dd className="text-black dark:text-zinc-50">
          ...
          {p.graded_at && (
            <div className="flex justify-between border-b border-zinc-200 pb-2 dark:border-zinc-800">
              <dt className="text-zinc-500">{t("gradedAt")}</dt>
              <dd className="text-black dark:text-zinc-50">
          ...
          <div className="flex justify-between pb-2">
            <dt className="text-zinc-500">{t("predictionId")}</dt>
