...
export default function PredictionLog({
  ...
  const t = useTranslations("PredictionLog");
      ...
      <div className="mt-4 flex items-center justify-between gap-4">
        ...
        <label className="flex items-center gap-1.5 text-xs text-zinc-500">
          ...
          >
            ...
            <option value="hit">{t("hits")}</option>
            <option value="miss">{t("misses")}</option>
          </select>
        </label>
      </div>
        ...
        <div className="mt-4 overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-800">
          <table className="w-full text-left text-sm">
            <thead className="border-b border-zinc-200 bg-zinc-100 text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900">
              <tr>
                <th scope="col" className="px-4 py-2 font-medium">{t("prediction")}</th>
                ...
                <th scope="col" className="px-4 py-2 font-medium text-right">{t("actual")}</th>
              </tr>
            </thead>
