...
export default function DataDictionaryPage() {
  const t = useTranslations("DataDictionaryPage");
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <Link href="/how-it-works" className="mt-10 inline-block rounded-md border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
          {t("howItWorks")} &rarr;
        </Link>
      </main>
    </div>
