      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/petey" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("askPetey")}
            </Link>
            <Link href="/lessons-learned" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("lessonsLearned")}
            </Link>
            <Link href="/model-changelog" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("modelChangelog")}
            </Link>
            <Link href="/bankroll" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("bankroll")}
            </Link>
            <Link href="/team-ratings" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("teamRatings")}
            </Link>
            <Link href="/how-it-works" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("howItWorks")}
            </Link>
            <Link href="/track-record" className="rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-900">
              {t("trackRecord")}
            </Link>
          </div>
        </div>
        ...
        <p className="mt-4 text-sm text-zinc-500 dark:text-zinc-400">
          {t("calibrationClaim")}{" "}
          <Link href="/track-record" className="underline underline-offset-2 hover:text-zinc-700 dark:hover:text-zinc-300">
            {t("calibrationClaimLink")}
          </Link>
        </p>
        ...
        {stats && (
          <div className="mt-6 flex flex-wrap gap-4">
            <div className="rounded-lg border border-zinc-200 bg-white px-5 py-3 dark:border-zinc-800 dark:bg-zinc-900">
              <p className="text-xs text-zinc-500">{t("gradedPredictions")}</p>
            ...
            {stats.bandHitRate !== null && (
              <div className="rounded-lg border border-zinc-200 bg-white px-5 py-3 dark:border-zinc-800 dark:bg-zinc-900">
                <p className="text-xs text-zinc-500">{t("hitRateBand")}</p>
                <p className="text-xl font-semibold text-black dark:text-zinc-50">
        ...
        {!data && (
          <div className="mt-10 rounded-lg border border-red-200 bg-red-50 p-4 text-red-800 dark:border-red-900 dark:bg-red-950 dark:text-red-200">
            {t("apiUnreachable")}{" "}
            <code className="font-mono">{API_URL}</code>. {t("apiUnreachableHint")}
          </div>
        )}
        ...
        {data && stale && fetchedAt && (
          <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-900 dark:bg-amber-950 dark:text-amber-200">
            {t("staleData", { time: timeAgo(fetchedAt) })}
          </div>
        )}
