...
export default function ThemeToggle() {
  ...
  return (
    <button onClick={toggle} aria-label={t("toggleDarkMode")} className="flex h-9 w-9 items-center justify-center rounded-full border border-zinc-300 bg-white text-zinc-700 shadow-md hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700">
      {isDark ? "\u2600" : "\u263D"}
    </button>
  );
}
