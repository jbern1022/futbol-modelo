    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      <main className="mx-auto max-w-2xl px-6 py-16">
        ...
        {data && data.standings.length === 0 && (
          <p className="mt-10 text-zinc-500">{t("noFinishedMatches", { season: data.season })}</p>
        )}
            ...
            <table className="w-full text-left text-sm">
              <thead className="border-b border-zinc-200 bg-zinc-100 text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900">
                <tr>
                  ...
                  <th scope="col" className="px-3 py-2 font-medium">{t("team")}</th>
                  <th scope="col" className="px-3 py-2 font-medium text-right">{t("played")}</th>
                  <th scope="col" className="px-3 py-2 font-medium text-right">{t("won")}</th>
                  <th scope="col" className="px-3 py-2 font-medium text-right">{t("drawn")}</th>
                  <th scope="col" className="px-3 py-2 font-medium text-right">{t("lost")}</th>
                  <th scope="col" className="px-3 py-2 font-medium text-right">{t("goalDiff")}</th>
                  <th scope="col" className="px-3 py-2 font-medium text-right">{t("points")}</th>
                </tr>
              </thead>
              <tbody>
