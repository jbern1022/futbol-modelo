...
# be noise.
typecheck:
	PYTHONPATH=src mypy --ignore-missing-imports scripts/generate_slate.py scripts/auto_slate.py scripts/auto_grade.py scripts/archive_old_shots.py scripts/check_model_drift.py scripts/check_pipeline_health.py api/judgment_filter.py
