...
# be noise.
typecheck:
	PYTHONPATH=src mypy --ignore-missing-imports scripts/generate_slate.py scripts/generate_nfl_slate.py scripts/auto_slate.py scripts/auto_grade.py scripts/archive_old_shots.py scripts/check_model_drift.py scripts/check_pipeline_health.py scripts/daily_digest.py src/ops/ntfy.py src/ingestion/api_football.py src/ingestion/nfl_data.py src/models/nfl_power_ratings.py api/judgment_filter.py
