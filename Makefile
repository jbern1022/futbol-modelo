...
# be noise.
typecheck:
	PYTHONPATH=src mypy --ignore-missing-imports scripts/generate_slate.py scripts/auto_slate.py scripts/auto_grade.py scripts/archive_old_shots.py api/judgment_filter.py
